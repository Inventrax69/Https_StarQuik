package com.inventrax.starquik.activities;
...
import com.inventrax.starquik.fragments.DeleteVLPDPickedItemsFragment;
import com.inventrax.starquik.fragments.DrawerFragment;
import com.inventrax.starquik.fragments.GoodsInFragment;
...
import com.inventrax.starquik.fragments.LoadBalancingFragment;
...
import com.inventrax.starquik.fragments.MaterialTransferFragment;
import com.inventrax.starquik.fragments.NewLoadSheetFragment;
import com.inventrax.starquik.fragments.OBDPickingDetailsFragment;
import com.inventrax.starquik.fragments.OBDPickingHeaderFragment;
import com.inventrax.starquik.fragments.OutboundRevertDetailsFragment;
import com.inventrax.starquik.fragments.OutboundRevertHeaderFragment;
import com.inventrax.starquik.fragments.PackingFragment;
...
import com.inventrax.starquik.fragments.SkuTransferFragment;
...
import com.inventrax.starquik.fragments.VLPDPickingDetailsFragment;
import com.inventrax.starquik.fragments.VLPDPickingHeaderFragment;
import com.inventrax.starquik.interfaces.ScanKeyListener;
import com.inventrax.starquik.logout.LogoutUtil;
import com.inventrax.starquik.model.NavDrawerItem;
import com.inventrax.starquik.util.AndroidUtils;
    ...
    public void ProcessScan(String ScannedData){
        ...
        if (ScannedData != null) {
            ...
            for (final Fragment fragment : fragmentManager.getFragments()) {
                ...
                if (fragment != null && fragment.isVisible() && fragment instanceof SkuTransferFragment) {
                    ((SkuTransferFragment) fragment).myScannedData(MainActivity.this, ScannedData);
                }
                ...
                if (fragment != null && fragment.isVisible() && fragment instanceof LoadBalancingFragment) {
                    ((LoadBalancingFragment) fragment).myScannedData(MainActivity.this, ScannedData);
                }
            }
        }
